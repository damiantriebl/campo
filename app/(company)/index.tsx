      ...
      <ScrollView style={styles.scrollContainer} showsVerticalScrollIndicator={false}>
        ...
        {empresas.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Miche Empresas</Text>
            ...
            {__DEV__ && (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  console.log('userCompaniesDetails:', userCompaniesDetails);
                  console.log('pendingRequestsCount:', pendingRequestsCount);
                  Alert.alert(
                    'Debug Info',
                    `Empresas: ${empresas.length}\nDetails loaded: ${Object.keys(userCompaniesDetails).length}`,
                    [
                      { text: 'OK' },
                      { text: 'Ver Consola', onPress: () => console.log('Check console for details') }
                    ]
                  );
                }}
              >
