        ...
        <View style={styles.rightContent}>
          <View style={styles.runningTotalContainer}>
            <Text style={[
              ...
              {formatCurrency(Math.abs(event.runningTotal))}
            </Text>
          ...
          {event.notas && event.notas.trim().length > 0 && (
            <TouchableOpacity
              style={[styles.notesIndicator, { marginTop: spacing.sm }]}
              onPress={onViewNotes}
            >
              <FontAwesome
                name="sticky-note"
      ...
      {showActions && onEdit && (
        <View style={[
          ...
          <TouchableOpacity
            ...
            onPress={onEdit}
          >
            <FontAwesome name="edit" size={16} color={colors.primaryAccent} />
            <Text style={[
...
const styles = StyleSheet.create({
  ...
  notesIndicator: {
    // Margin will be applied inline using theme
  },
  actionButtons: {
    flexDirection: 'row',
