...
export default function ProductSelector({
  ...
  const loadProducts = async () => {
    ...
    try {
      ...
      // Enhance products with cached price information
      const enhancedProducts: ProductWithPrices[] = productList.map(product => {
        const cachedPrices = productService.getLastUsedPrices(product.id);
        return {
          ...product,
          cachedCosto: cachedPrices.ultimoCosto,
          cachedGanancia: cachedPrices.ultimaGanancia,
          hasCachedPrices: cachedPrices.ultimoCosto !== undefined && cachedPrices.ultimaGanancia !== undefined,
        };
      });
